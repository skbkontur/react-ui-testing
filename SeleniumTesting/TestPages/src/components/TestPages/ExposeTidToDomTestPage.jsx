    ...
    render(): React.Element<*> {
        return (
            <CaseSuite title='Механизм переноса props-ов в DOM'>
                ...
                <Case title='Разные элементы переключаются между одним дом элементом (указан key)' data-tid='SameDomElementWithKeyCase'>
                    <Case.Body>
                ...
                <Case title='Вложения корневых компонент' data-tid='NestingComponentsCase'>
                    <Case.Body>
                        <NestingContainer
                            data-tid={'NestingComponentsContainer'}
                            state={this.state.case4State} />
                        <Button
                            data-tid='SwitchState'
                ...
                <Case title='Вложения dom-элементов' data-tid='NestingDomElementsCase'>
                    <Case.Body>
                        <NestingContainer
                            data-tid={'NestingDomContainer'}
                            state={this.state.case5State} />
                        <Button
                            data-tid='SwitchState'
                ...
                <Case title='Двойное вложения комопнент' data-tid='DoubleNestingComponentsCase'>
                    <Case.Body>
                        <DoubleNestingContainer
                            data-tid={'DoubleNestingContainer'}
                            state={this.state.case6State} />
                        <Button
                            data-tid='SwitchState'
